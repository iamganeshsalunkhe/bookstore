    ...
    return (
      ...
      <ul
        ...
        <label className="input input-bordered flex items-center gap-2">
            ...
            <input type="checkbox" className="theme-controller" value="synthwave"  name="theme-controller"/>
        ...
        {authuser ? <Logout/> :  
       <div >
        <Link className="bg-green-500 text-white py-2 px-3 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>document.getElementById('my_modal_3').showModal()}>Login</Link>
        <Login/>
        </div> 
        }
        </div>    
