...
function Navbar() {
    ...
    return (
      ...
      <div >
        <Link className="bg-black text-white py-2 px-3 rounded-md hover:bg-slate-800 duration-300 cursor-pointer" onClick={()=>document.getElementById('my_modal_3').showModal()}>Login</Link>
        <Login/>
        </div>
        </div>    
    </div>
